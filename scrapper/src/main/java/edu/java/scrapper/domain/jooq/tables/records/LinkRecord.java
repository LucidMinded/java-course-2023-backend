...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
     ...
     */
    @ConstructorProperties({ "id", "url", "updatedAt", "lastActivity" })
    public LinkRecord(@Nullable Long id, @NotNull String url, @NotNull OffsetDateTime updatedAt, @NotNull OffsetDateTime lastActivity) {
        super(Link.LINK);
